...
<?php
    ...
    if (isset($_POST['empid']) && isset($_POST['password'])) {
        ...
        if ($_POST['empid'] == 'admin_landscape' && password_verify($_POST['password'],'$2y$10$xahYhjBeRs8hbxTozvHNqe//YeBX6/EoxdV71IpsciVVuP3YWNHNa')) {
            $_SESSION['admin_logged_in'] = true;
            header('Location: home_landscaping.php');
        }
        else{
...
<div class="col-md-8">
                <div class="card">
                    <div class="card-header">Landscape Admin Login</div>
...
?>
                        <form method="post">
                            ...
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="home_lanscaping.php" class="btn btn-link">
                                    Home Page
                                </a>
                            </div>
                        </form>
